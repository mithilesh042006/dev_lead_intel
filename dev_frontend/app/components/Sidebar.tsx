...
const NAV: NavItem[] = [
  {
    ...
    icon: (
      <svg viewBox="0 0 20 20" fill="none" className="h-4 w-4 shrink-0" aria-hidden="true">
        ...
        <rect x="10.75" y="3.75" width="5.5" height="3" rx="1.25" stroke="currentColor" strokeWidth="1.5" />
        <rect x="3.75" y="10.75" width="5.5" height="5.5" rx="1.25" stroke="currentColor" strokeWidth="1.5" />
        <rect x="10.75" y="8.25" width="5.5" height="8" rx="1.25" stroke="currentColor" strokeWidth="1.5" />
      </svg>
    ),
  },
  {
